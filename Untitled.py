...
def rdw_data():
    ...
    st.write("""
        Aangezien de datasets bestaan uit respectievelijk 15.1 miljoen rijen met 93 kolommen en 14.4 miljoen rijen met
        ...
        Op deze manier kunnen ze wel ingeladen en samengevoegd worden.....
